#!/usr/bin/env python3
"""
Script modular para crear la base de datos.

Esta versión utiliza los módulos de schema para una mejor
...
class DatabaseCreator:
    """Crea la base de datos con estructura modular."""
...
def main():
    ...
    parser = argparse.ArgumentParser(description='Crear base de datos modular para Universal Camera Viewer')
