...
class DatabaseSeeder:
    ...
    def seed_cameras(self, clear_first: bool = False) -> None:
        ...
        cameras = [
            ...
            {
                "camera_id": generate_camera_id(),
                "code": "CAM-TPLINK-TAPO-77",
                "brand": "tplink",
                "model": "Tapo C520WS",
                "display_name": "Cámara TP-Link Exterior",
                "ip_address": "192.168.1.77",
                "mac_address": "F0:A7:31:D8:64:E8",
                "location": "Exterior",
                "description": "Cámara TP-Link Tapo C520WS con visión nocturna y WiFi",
                "username": "admin-tato",
                ...
                "capabilities": ["rtsp", "https", "motion_detection", "night_vision", "wifi"],
                "endpoints": [
                    {
                        "type": "rtsp_main",
                        "name": "Stream Principal",
