"""
Panel de progreso mejorado para el escaneo de puertos.
Incluye animaciones, métricas de rendimiento y mejor feedback visual.
"""
...
# cspell:disable
class ImprovedScanProgressPanel:
    """
    ...
    def __init__(self, parent_container: tk.Widget):
        """
        Inicializa el panel de progreso mejorado.
